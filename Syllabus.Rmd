...
2. The basics of research designs in psychology, and how they relate to data-anlaysis strategies
...
The [lab manual](https://crumplab.github.io/statisticsLab/) for this cours is also free, and is available online as a web-book.
...
- Part 2 activities: After you see how we did something in Part 1, you try to do something very similar in part 2. You will show your work in a file that we give you. You may or may not be able to succesfully complete the generalization assignment. That is ok. You will pa
...
#### Midterm (20%) and Final Exam (Cumulative 25%)
...
**Q. What's on the exams?** A: the midterm and final have the same stucture. Half of each exam is multiple choice questions, the other half is long-answer questions
...
LECTURE ATTENDANCE POLICY: If a student is late or misses more than 3 classes, then each additional late/missed class will result in subtracting 1% from the 15% for the Weekly quizzes. We know that life happends and sometimes you can't make it to class. We are giving you you three classes where you can miss (because of things happening in your life that we don't need to know about) without having any impact on your grade (all lecture notes are online for missed classes, talk to a friend, read the textbook, etc.)
